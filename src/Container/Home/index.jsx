  ...
  return (
    <C.ContainerAll>
      ...
      <C.DivObjetivo>
        ...
        <C.Text>
          Nosso objetivo é desenvolver um aplicativo onde seja viabilizada a
          carona gratuitamente entre alunos da graduação, disponibilizando
          desconto ou vale-gasolina para os motoristas pela boa ação.
        </C.Text>
      </C.DivObjetivo>
      <C.ContainerImageOne>
      ...
      <C.DivEco>
        ...
        <C.Text>
          Carry é uma empresa com proposito ecológico que tem como meta atingir
          uma sociedade mais ecológica limpa. Menos um carro na rua é menos
          liberação de gás carbônico impactando positivamente a vida de todos.
        </C.Text>
      </C.DivEco>
      <C.ContainerImagetwo>
